          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Shurthika R</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Miro</span>
                <span className="text-gray-400">{"', '"}</span>
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Axure</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Invision</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Sketch</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">JustinMind</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Framer</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Spline</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Protopie</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Marvel</span>
                <span className="text-gray-400">{"'],"}</span>
              </div>
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Wire-framing</span>
                <span className="text-gray-400">{"', '"}</span>
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                <span className=" text-white">Al Tools:</span>
                <span className="text-gray-400">{`['`}</span>
                <span className="text-amber-300">DoraAl</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Adobe Aero</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Midjourney</span>
                <span className="text-gray-400">{"', '"}</span>
